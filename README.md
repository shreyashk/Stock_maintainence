...
By following the tutorial i have made some changes so that these can be used by any shop to maintain inventory list and add runtime images.
You also get features to Filter by Categories and Search a Product by its name.
