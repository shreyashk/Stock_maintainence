...
By following the tutorial i have made some small changes so that these can be used by any shop to maintain inventory list and add runtime images.
You also get options to Filter by Categories and Search a Product by its name.
